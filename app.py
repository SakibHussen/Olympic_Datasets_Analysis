...
df = preprocessor.preprocess(df, regeion_df)

user_menu = st.sidebar.radio(
    'Select an Option',
    ('Median Tally', 'Overall Analysis', 'Country-wise Analysis', 'Athlete wise Analysis')

)
#Displaying data
st.dataframe(df)
if user_menu == 'Median Tally':
    ...
    if selected_years == 'Overall' and selected_years == 'Overall':
...
if user_menu == "Overall Analysis":
    ...
    athlete_Over_Time = helper.participating_nations_over_time(df, 'Name')
...
if user_menu == 'Athlete wise Analysis':
    ...
    fig.update_layout(autosize=False, width=1000, height=600)
    st.title("Distribution of Age with Sports(Gold Medalist)")
    st.plotly_chart(fig)
