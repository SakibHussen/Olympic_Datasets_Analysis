...
def medal_tally(df):
    medal_tally = df.drop_duplicates(subset=['Team', 'region', 'Games',
...
def most_successful(df, sport):
    ...
    temp_df_counts.columns = ['Name', 'Medals']  # Renaming columns for clarity

    # Merge with the original dataframe to get additional information
    x = temp_df_counts.head(15).merge(df, on='Name', how='left')[
